...
@section('content')
<main class="p-2 sm:px-2 flex-1 overflow-auto bg-black">
        ...
        <div class="bg-gray-900 rounded-lg p-6">
            <div class="flex items-center gap-3 mb-6">
                <div class="w-8 h-8 rounded-full bg-gray-800 flex items-center justify-center">
                    @if(strtolower($stake->crypto_type) == 'cro')
                        <img src="https://web-cms-cdn.uphold.world/2688237b-57a2-44db-9f11-cbb0bcf767d1_cronos-cro-logo.svg" alt="{{ $stake->crypto_type }}" class="w-10 h-10" />
                    @elseif(strtolower($stake->crypto_type) == 'egld')
                        <img src="https://c8.alamy.com/zooms/9/ad4d3c4110d943e4aed21355d3cd4078/2gy0efx.jpg" alt="{{ $stake->crypto_type }}" class="w-10 h-10" />
                    @else
                ...
                <div class="bg-gray-800 rounded-lg p-4">
                    <div class="flex items-center gap-3 mb-4">
                        <div class="w-8 h-8 rounded-full bg-gray-700 flex items-center justify-center">
                            @if(strtolower($getUserStake->crypto_type) == 'cro')
                                <img src="https://cryptologos.cc/logos/crypto-com-coin-cro-logo.png" alt="{{ $getUserStake->crypto_type }}" class="w-10 h-10" />
                            @elseif(strtolower($getUserStake->crypto_type) == 'egld')
                                <img src="https://cryptologos.cc/logos/multiversx-egld-egld-logo.png" alt="{{ $getUserStake->crypto_type }}" class="w-10 h-10" />
                            @else
