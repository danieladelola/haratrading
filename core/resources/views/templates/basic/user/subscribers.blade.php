...
<main class="p-2 sm:px-2 flex-1 overflow-auto bg-gray-900 text-gray-100">
    <div>
        <div class="p-4 bg-gray-800 rounded-lg shadow-lg border border-gray-700">
            <div class="flex justify-between items-center">
                <div>
                    <h3 class="text-sm text-gray-400">Total Balance</h3>
                    <p class="text-2xl font-semibold text-white">{{ showAmount(auth()->user()->balance) }}</p>
                </div>
                    ...
                    <div x-data="{ isOpen: false }">
                        ...
                        >
                            ...
                            <div class="absolute inset-y-0 right-0 max-w-xl w-full">
                                <div class="h-full flex flex-col bg-gray-800 shadow-xl border-l border-gray-700">
                                    <!-- Header -->
                                    <div class="px-6 py-4 border-b border-gray-700 flex items-center justify-between">
                                        <h2 class="text-xl font-semibold text-white">Subscriptions ROI</h2>
                                        <div class="flex items-center gap-4">
                                            <!-- Close Button -->
                                            <button @click="isOpen = false" class="p-2 hover:bg-gray-700 rounded-full">
                                    ...
                                    <div class="flex-1 overflow-y-auto p-6 bg-gray-800">
                                        ...
                                        $daysRemaining = max(0, \Carbon\Carbon::now()->diffInDays($expirationDate, false));
                                        $daysRemainingFormatted = number_format($daysRemaining, 0) . ' ' . Str::plural('day', $daysRemaining);
                                        @endphp
                                            <div class="mb-6 p-4 bg-gray-700 rounded-lg border border-gray-600 shadow">
                                                <div class="flex justify-between items-center mb-4">
                                                    <h3 class="text-lg font-medium text-white">{{ $subscription->name }}</h3>
                                                ...
                                                <div class="space-y-3">
                                                    <div class="flex justify-between">
                                                        ...
                                                        <span class="font-medium text-white">${{ number_format($subscription->amount, 2) }}</span>
                                                    </div>

                                                    <div class="flex justify-between">
                                                        <span class="text-gray-400">ROI Percentage</span>
                                                        <span class="font-medium text-white">{{ $subscription->roi }}%</span>
                                                    </div>

                                                    <div class="flex justify-between">
                                                        <span class="text-gray-400">Duration</span>
                                                        <span class="font-medium text-white">{{ $subscription->duration_days }} days</span>
                                                    </div>
                                                    ...
                                                    <div class="flex justify-between">
                                                        ...
                                                        <span class="font-medium {{ $daysRemaining < 7 ? 'text-red-400' : 'text-white' }}">
                                                    ...
                                                    <div class="pt-3 border-t border-gray-600">
                                                        <div class="flex justify-between text-lg font-semibold">
                                                            <span class="text-gray-400">Total ROI</span>
                                                            <span class="text-green-400">${{ number_format($totalRoi, 2) }}</span>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="pt-2">
                                                        <div class="flex justify-between text-sm">
                                                            ...
                                                            <span class="text-green-400">${{ number_format($dailyRoi, 2) }}</span>
                                                        </div>
                                                        <div class="flex justify-between text-sm">
                                                            <span class="text-gray-400">Monthly ROI</span>
                                                            <span class="text-green-400">${{ number_format($monthlyRoi, 2) }}</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
            ...
            <div class="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="bg-gray-700 rounded-lg p-6 border border-gray-600">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input type="text" name="amount" value="{{ $subscription->minimum_amount }}"
                                    class="w-full bg-gray-600 text-white px-3 py-2 rounded border border-gray-500 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500">
                        ...
                        <button type="submit" class="w-full bg-blue-600 text-white py-3 rounded hover:bg-blue-700 transition-colors mt-4">
                            Subscribe
                        </button>
                    </form>
                    </div>
